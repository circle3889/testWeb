var Swiper = function (selector, params) {
    ...
    function handleMousewheel(e) {
        ...
        if (params.autoplay) _this.SwipeStopAutoplay(true);
    ...
    _this.swipeNext = function (runCallbacks, internal) {
        ...
        if (!internal && params.autoplay) _this.SwipeStopAutoplay(true);
    ...
    _this.SwipeStartAutoplay = function () {
        if (_this.support.transitions) {
    ...
    _this.SwipeStopAutoplay = function (internal) {
        if (_this.support.transitions) {
