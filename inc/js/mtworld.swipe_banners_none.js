Banners = {
	/*getBannerData : function(opt){
		$.post("/json/main_banner.json", function(data) {*/ /* 2016-08-19  공통 사용을 위한 수정 */
	getBannerData : function(opt, url){
		if(url == undefined) url = "/json/main_banner.json" 
		$.post(url, function(data) {
			...
			//BannerSwiper.itemLength = tempArray.length;
...
//									if(BannerSwiper.touches.direction == "right"){
//										nextIdx = (BannerSwiper.currIdx + 1) % $("#" + BannerSwiper.targetParentId + " #" + BannerSwiper.targetID + " > div").length
//										$($("#" + BannerSwiper.targetParentId + " #" + BannerSwiper.targetID + " > div")[nextIdx]).removeClass("swiper-slide-hide").css({
//											"left": BannerSwiper.touches.touchstart.nextLeft + diff
//										});
//									} else {
//										nextIdx = (BannerSwiper.currIdx - 1) < 0 ? BannerSwiper.count-1 : (BannerSwiper.currIdx - 1);
//										$($("#" + BannerSwiper.targetParentId + " #" + BannerSwiper.targetID + " > div")[prevIdx]).removeClass("swiper-slide-hide").css({
//											"left": BannerSwiper.touches.touchstart.prevLeft + diff
//										});
//									}
//								}
						...
						//console.log(BannerSwiper.ismoveYaxis, BannerSwiper.ismoveXaxis, touch);
						break;
					case 'touchend':
